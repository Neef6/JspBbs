...
<html>
  ...
  <body style="height:100%;margin:0px;font-size:12px;">
        ...
        <dl>
        	<dt>&nbsp;</dt>
			<dd style="padding:6px;"><img style="width:16px;height:16px;margin-bottom:-4px;padding-right:4px;" alt="" src="${basePath }img/bbs_user.gif"/><a href="${basePath }userAction?cmd=findUserByName" target="right">用户信息</a></dd>
